...
const customizedTheme = createMuiTheme({
  ...
  shadows: [
    ...
    "0px 3px 3px -2px rgba(195, 195, 195, 0.2),0px 3px 4px 0px rgba(195, 195, 195, 0.14),0px 1px 8px 0px rgba(195, 195, 195, 0.12)",
    // "0px 2px 4px -1px rgba(0,0,0,0.2),0px 4px 5px 0px rgba(0,0,0,0.14),0px 1px 10px 0px rgba(0,0,0,0.12)",
    "0px 2px 4px -1px rgba(195, 195, 195, 0.2), 0px 4px 5px 0px rgba(195, 195, 195, 0.14), 0px 1px 10px 0px rgba(195, 195, 195, 0.12)",
